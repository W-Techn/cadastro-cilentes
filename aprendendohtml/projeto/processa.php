        ...
        case 14:
            ...
            // e comunicar-nos com o banco de dados para inserir a mensagem armazenada na nossa varável String criada;
                if (mysqli_insert_id($conn)) {  //se a conexão com o banco de dados foi bem sucedida, ela terá acrescentado um novo valor na tabela, e o contador ID terá sido somado em 1. A função mysqli_insert_id verifica se isso aconteceu
                    ...
                    $_SESSION['msg2'] = "<p style='color:#ff0000; font-size:1.1rem;'>*Este CNPJ já foi cadastrado</p>"; //a nova sessão imprimira uma mensagem de erro em vermelho, dizendo que esse CPF passado já se encontra na tabela. 
                    header("Location: index.php"); //Só pode ser esse o erro, pois se não o front-end já teria retido a informação passada erroneamente para esta interface;
                }
            } else { //se a o segundo dígito não passar na verificação,
                $_SESSION['msg2'] = "<p style='color:#ff0000; font-size:1.1rem;'>*Este CNPJ não existe!</p>"; //significa que ele não existe, e é isso que nós passaremos a imprimir na nova seção que será aberta, no redirecionamento que haverá
                header("Location: index.php"); //para a página Index;
            }
            
            break;
        default:
        $_SESSION['msg2'] = "<p style='color:#ff0000; font-size:1.1rem;'>*Valor inválido</p>"; //significa que ele não existe, e é isso que nós passaremos a imprimir na nova seção que será aberta, no redirecionamento que haverá
